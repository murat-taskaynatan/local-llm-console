...
LocalRemoteFetchCatalog=async function(e){let t=LocalRemoteModelsUrl(e);if(t==null)return{localRemoteCatalog:!0,models:[],error:`Remote endpoint URL is missing.`};try{let n=await LocalRemoteFetchBridge.getInstance().get(t,{accept:`application/json`}),r=LocalRemoteModelNames(n?.body??n);return{localRemoteCatalog:!0,models:r,error:r.length===0?`Remote endpoint returned no models.`:null}}catch{return{localRemoteCatalog:!0,models:[],error:`Cannot reach remote endpoint.`}}};
//# sourceMappingURL=font-settings-Bd-F4ufE.js.map
import{w as LocalRemoteFetchBridge}from"./vscode-api-D-CkvzxH.js";
